...
public class StudentStream {
		...
		private StuSubject sub;
		private String classname;
		public StudentStream(int rollno, LocalDate date_of_addmission, LocalDate dob, StuSubject sub,
				String classname) {
			super();
			this.rollno = rollno;
		...
		public StuSubject getSub() {
			return sub;
		}

		public void setSub(StuSubject sub) {
			this.sub = sub;
		}
