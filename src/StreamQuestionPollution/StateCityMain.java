package StreamQuestionPollution;
...
public class StateCityMain {
		...
		public static void main(String[] args) {
			...
			List<CityStream> cs = Arrays.asList(
					...
					new CityStream(4, "jalgaon", new StateStream(102, "telangana"), 8f, 650000, 350),
					new CityStream(5, "delhi", new StateStream(103, "bihar"), 6f, 450000, 500),
					new CityStream(6, "solapur", new StateStream(103, "bihar"), 8.6f, 600000, 300));
